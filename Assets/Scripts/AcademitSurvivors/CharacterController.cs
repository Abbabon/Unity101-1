...
namespace AcademitSurvivors
{
    public class CharacterController : MonoBehaviour
    {
        ...
        [FormerlySerializedAs("_shootingCooldown")] [SerializeField] private float _shootingCooldownDuration;
        [SerializeField] private Image _cooldownImage;
        [SerializeField] private ObjectPool _bulletFactory;
        ...
        private void Shoot()
        {
            ...
            var bullet = _bulletFactory.GetObjectFromPool();
            bullet.transform.position = _shotsOrigin.transform.position;
